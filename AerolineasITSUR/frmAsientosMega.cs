...
{
    public partial class frmAsientosMega : Form
    {
        Double subtotal = 0;
        ...
        public void escribirVuelo(Vuelo nvuelo)
        {
            ...
            escribirEstandar = File.AppendText("Mega.txt");
        ...
        {
            lectorArchivo = File.OpenText("Mega.txt");
        ...
        private void frmAsientosMega_Load(object sender, EventArgs e)
        {
