...
{
    public partial class frmAsientosPlus : Form
    {
        ...
        public void escribirVuelo(Vuelo nvuelo)
        {
            ...
            escribirEstandar = File.AppendText("Plus.txt");
        ...
        {
            lectorArchivo = File.OpenText("Plus.txt");
        ...
        private void frmAsientosPlus_Load(object sender, EventArgs e)
        {
